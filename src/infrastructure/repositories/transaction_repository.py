...
class TransactionRepository:
    ...
    def _to_orm_transaction(self,transaction: DomainTransaction) -> ORMTransaction:
    ...
    def get_by_id(self,transaction_id: UUID) -> DomainTransaction | None:
    ...
    def get_entries(self,transaction_id: UUID) -> list[DomainEntry]:
        ...
        return [self._to_domain_entry(entry) for entry in entries]

    def create(self,transaction: DomainTransaction) -> DomainTransaction:
